...
dch -v "1.13.$TRAVIS_BUILD_NUMBER-0$1" --distribution $1 "Travis CI Build"
git add debian/changelog
git commit -m "Travis CI Build"

git clean -xfd

git archive --format tar.gz -o ../libplist_1.13.${TRAVIS_BUILD_NUMBER}.orig.tar.gz HEAD
...
dput ppa:quamotion/ppa ../libplist_1.13.${TRAVIS_BUILD_NUMBER}-0$1_source.changes
